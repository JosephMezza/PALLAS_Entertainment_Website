...
<head>
    ...
    <style type="text/css">
        ...
        .bubbles {
            /* The background image used in the navbar is added as a background to all of the sections showcasing the artists. Shadows are also added for depth */
            margin: 20px;
            padding: 10px;
            color: white;
            border-radius: 8px;
