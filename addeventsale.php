...
// Define variables and initializes them
    ...
    while ($rows = mysqli_fetch_assoc($result)) {
        if ($rows['email'] == $_SESSION["email"] && $rows['eventtype'] == "public") {
            ...
            if (empty($eventLocation_err) && empty($eventPrice_err) && empty($entertainmentType_err) && empty($discountedEvent_err)) {
                ...
                // Finds which services are associated with a given date in the quoteform table to transfer it to the upcoming event table
                ...
                // Inserts data in the database or display an error message
        ...
        <div class="">
            ...
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                ...
                <select name="EventDate">
                    <?php //Display for which date the user can create an event for 
