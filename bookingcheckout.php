            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div class=border>
                            <label>
                                <input class="center" type="radio" name="card_type" placeholder="Card Type"  value="credit" checked>
                                <br>
                                <div class="center">
                                    Credit Card
                                </div>
                    ...
                    <td rowspan=5>
                        <table>
                            ...
                            <tr>
                                <td colspan="3">Price: <p id="dynamicPrice"> $<?php echo $price; ?></p>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td colspan="3">Subtotal: <p id="subtotal"> $<?php echo $price; ?></p>
                                </td>
                            </tr>
